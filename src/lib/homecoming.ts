...
export const HC_FAQ = [
  {
    q: "누가 참가할 수 있나요?",
    a: "하이톤을 기억하는 성인(2005년생 이하)을 대상으로 합니다. 과거 하이톤 참가 여부와 무관하게, 일찍 IT 진로를 택한 분이라면 환영합니다.",
  },
  {
  ...
  {
    q: "뒤풀이도 있나요?",
    a: "행사 종료 후 사전 신청자를 대상으로 뒤풀이가 진행됩니다. 신청 방법은 행사 전후 별도로 안내드립니다.",
  },
  {
    q: "준비물이나 복장이 있나요?",
...
export const HC_SCHEDULE = [
  ...
  { time: "18:00 –", program: "뒤풀이", detail: "사전 신청자 대상" },
] as const;
